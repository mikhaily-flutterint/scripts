...
$Time = Get-Date
$Workset = Invoke-DbaQuery -SqlInstance $ControlServer -Query "SELECT DISTINCT server_name FROM landscape.dbo.database_servers WHERE server_name  = 'IMDGNDWSQLP79'"

if ($Workset -ne $null) {
    foreach($Item in $Workset){
    Write-Host $Item.server_name   
    $Result = Get-DbaDiskSpace -ComputerName $Item.server_name   

    $Result | Select-Object -Property ComputerName, Name, Label, PercentFree, BlockSize, DriveType , `
    SizeInBytes ,FreeInBytes ,SizeInMB ,FreeInMB ,SizeInGB,FreeInGB, @{ l='Time'; e={ $Time } } `
    | Write-DbaDataTable -SqlInstance $ControlServer -Database "landscape" -Table "landscape.dbo.fs_raw_history"
    }
}
# SIG # Begin signature block
# MIINcwYJKoZIhvcNAQcCoIINZDCCDWACAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUO2wDXQ65IGufpUMx9CEbaf8/
# 4CGgggrdMIIFDDCCAvSgAwIBAgITFwAAAANoHQGylzOSswAAAAAAAzANBgkqhkiG
...
# DjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTr1e3yHVDYeTubwZ7DKEqU
# X0FnMzANBgkqhkiG9w0BAQEFAASCAQDX7GKCe0am2hA4KqpG4fuTA5+4SexHIqXg
# gfSIHhhm0fsYFzrILN+NVOBgVp9kzfZx6Uvgr46AA+/SZI5id38e4YXw5upWXZdi
# Cr4PBOP3ha1rEMYxBY7MMn6VgvJ11gmb3te2GDgPcyWNIuo311P+5e2UuCQBgrHL
# gNN9IrxvUyEsHbMyWQp8M+A8RPSGiC2eSvN7cFFA/SF3PLXr8Lx09aoHYe0yfOU9
# gVigdN81AKqsncw4mwCiiVEH+OWhUItzEveSyECEhnmBmwncV6XZuZd4E2p+OV97
# +nlrlaxFCW1eRqavjZmA+hcfdEutFLzvlRcCQNZQUMUJlTGEiFk2
